...
const SuggestChannelsWithHashtags = () => {
  ...
  return (
    <div>
      <Heading
        title="Suggest Channels With Video Url"
        description="You can have a look YouTube channels based on your youtube channel url."
      ...
      <div className="app px-8 py-8">
        <div className="flex items-center">
          <h1 className="text-xl font-semibold mr-4">
            Search the channel based on your taste video!
          </h1>
          <button
